...
import team_isaac from "../assets/img/team_isaac.jpg";
...
const teamMembers = [
  ...
  {
    name: "Isaac Thompson",
    position: "Post Bachelors Research Associate",
    photo: team_isaac,
    email: "isaac.thompson@pnnl.gov"
  },  
];
      ...
      <Container>
        ...
        <hr className="home-hr" />
          <div className="page-subtitle">
            The GCIMS Integration team works on setting guidelines, monitoring and tracking the models produced by our full team of water, energy, land, and climate scientists at the Joint Global Change Research Institute <a href="https://www.pnnl.gov/projects/jgcri" target="_blank" rel="noreferrer">(JGCRI)</a>.<br></br> Key contributors to the GCIMS Integration project are listed below. 
          </div>
        </Row>
